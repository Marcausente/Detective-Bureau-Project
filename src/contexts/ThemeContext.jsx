...
export const BRANDING_PRESETS = {
    SCUB: {
        ...
        gangs_nav_label: 'Bandas',
        gangs_title: 'Gangs & Narcotics Division',
        seb_nav_label: 'SEB',
        seb_badge: 'Special Enforcement Bureau',
        seb_title: 'División Operativa de Alto Riesgo',
        seb_subtitle: 'Tablón de operaciones y planificación táctica interactiva.',
        seb_logo: '',
        training_nav_label: 'Formación',
        training_title: 'Detective Training Program',
        training_subtitle: 'Departamento de Instrucción y Capacitación Continua',
        training_logo: '/logowebp/DTP logo.webp',
        ia_nav_label: 'Asuntos Internos',
        ia_badge: 'Sheriff Internal Affairs Division',
        ia_title: 'ASUNTOS INTERNOS',
        ia_logo: '/logowebp/IALSSD.webp',
        asd_nav_label: 'Air Support',
        asd_badge: 'ASD • S.C.U.B. / SAPD',
        asd_title: 'AIR SUPPORT DIVISION',
        asd_subtitle: 'Cuadrilla y Gestión Jerárquica de Vuelo, Habilitaciones e Infracciones de la División',
        asd_logo: '',
    ...
    DB: {
        ...
        gangs_nav_label: 'Bandas',
        gangs_title: 'Gang Intelligence Unit',
        seb_nav_label: 'SWAT',
        seb_badge: 'Special Weapons and Tactics (SWAT)',
        seb_title: 'Unidad Táctica de Asalto & Operaciones',
        seb_subtitle: 'Tablón de despliegue operativo e intervenciones de alto riesgo.',
        seb_logo: '',
        training_nav_label: 'Academia',
        training_title: 'Detective Training Program',
        training_subtitle: 'Academia Central de Formación y Calificación Policial',
        training_logo: '/logowebp/DTP logo.webp',
        ia_nav_label: 'Asuntos Internos',
        ia_badge: 'Internal Affairs Bureau',
        ia_title: 'INTERNAL AFFAIRS BUREAU',
        ia_logo: '/logowebp/ialogo.webp',
        asd_nav_label: 'Air Support',
        asd_badge: 'ASD • LSPD / SAPD',
        asd_title: 'AIR SUPPORT DIVISION',
        asd_subtitle: 'Centro de Operaciones Aéreas y Gestión de Vuelo Policial',
        asd_logo: '',
        undercover_nav_label: 'Undercover',
    ...
    LSSD: {
        ...
        login_bg: '/logowebp/fondolssd.webp',
        gangs_nav_label: 'Gang Unit',
        gangs_title: 'Gangs & Narcotics Division (GND)',
        seb_nav_label: 'SEB',
        seb_badge: 'Special Enforcement Bureau',
        seb_title: 'División Operativa de Alto Riesgo',
        seb_subtitle: 'Tablón de operaciones y planificación táctica interactiva.',
        seb_logo: '',
        training_nav_label: 'Formación',
        training_title: 'Sheriff Training Bureau',
        training_subtitle: 'Departamento de Instrucción y Capacitación del Sheriff',
        training_logo: '/logowebp/DTP logo.webp',
        ia_nav_label: 'Asuntos Internos',
        ia_badge: 'Sheriff Internal Affairs Division',
        ia_title: 'ASUNTOS INTERNOS',
        ia_logo: '/logowebp/IALSSD.webp',
        asd_nav_label: 'Air Support',
        asd_badge: 'ASD • Sheriff Aero Squadron',
        asd_title: 'SHERIFF AERO BUREAU (ASD)',
        asd_subtitle: 'Patrullaje aéreo y apoyo táctico del Sheriff',
        asd_logo: '/logowebp/LSSDlogo.webp',
    ...
    SAPD: {
        ...
        login_bg: '/logowebp/indeximage.webp',
        gangs_nav_label: 'Bandas',
        gangs_title: 'State Gang Task Force',
        seb_nav_label: 'SWAT',
        seb_badge: 'State Tactical Operations (SWAT)',
        seb_title: 'División de Respuesta Inmediata & Asalto',
        seb_subtitle: 'Planificación de operativos estatales de máxima seguridad.',
        seb_logo: '',
        training_nav_label: 'Academia',
        training_title: 'State Police Academy',
        training_subtitle: 'Centro de Instrucción y Capacitación Estatal',
        training_logo: '/logowebp/sanandreas.webp',
        ia_nav_label: 'Asuntos Internos',
        ia_badge: 'State Internal Affairs Office',
        ia_title: 'OFICINA DE ASUNTOS INTERNOS',
        ia_logo: '/logowebp/sanandreas.webp',
        asd_nav_label: 'Air Support',
        asd_badge: 'SAPD • State Air Division',
        asd_title: 'STATE AIR SUPPORT DIVISION',
        asd_subtitle: 'Gestión de aeronaves y vigilancia aérea estatal',
        asd_logo: '/logowebp/sanandreas.webp',
