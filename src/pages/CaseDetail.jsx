                            ...
                            <div className="updates-feed">
                                {updates.length === 0 ? <div className="empty-list">{t('noUpdatesRecorded')}</div> : (
                                    updates.map(update => {
                                        ...
                                        return (
                                            <div key={update.id} id={`update-${update.id}`} className="case-update-card" style={{
                                                    ...
                                                    <div style={{ marginBottom: '1rem' }}>
                                                        ...
                                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '0.5rem' }}>
                                                            ...
                                                            <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                                                                <button className="login-button btn-secondary" onClick={() => { setEditingId(null); setEditImages([]); }} style={{ width: 'auto', padding: '0.3rem 0.8rem', fontSize: '0.8rem' }}>{t('cancelBtn')}</button>
                                                                <button className="login-button" onClick={() => handleSaveEdit(update.id)} disabled={submittingEdit} style={{ width: 'auto', padding: '0.3rem 0.8rem', fontSize: '0.8rem' }}>
                                                                    {submittingEdit ? (language === 'es' ? 'Guardando...' : 'Saving...') : t('saveChangesBtn')}
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
