...
function Profile() {
    const { t } = useLanguage();
    const { isLSSD, toggleTheme } = useTheme();
        ...
        <div className="mac-profile-container">
            ...
            <div className="mac-command-banner">
                ...
                <div className="mac-action-bar">
                    <button className="mac-btn mac-btn-secondary" onClick={toggleTheme} title="Cambiar tema visual">
                        ...
                        Tema: {isLSSD ? 'LSSD (Esmeralda)' : 'SAPD (Azul)'}
                    </button>
                </div>
            </div>
