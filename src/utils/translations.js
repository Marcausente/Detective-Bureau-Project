export const translations = {
    en: {
        ...
        undercoverDivision: "Undercover Division",
        ud: "UD",
        coordination: "Coordination",
        coordinationTasks: "Coordination Pending Tasks",
        sanctionsRegister: "Sanctions Register",
        ...
        dateTime: "Date & Time",
        initialReport: "Case Keys / Description",
        initialReportPlaceholder: "Describe the case keys...",
        ...
        deleteBtn: "Delete",
        initialReportTitle: "CASE KEYS",
        clickToExpand: "Click to expand",
        updatesAndEvidenceTab: "Updates & Evidence",
        toDoListTab: "To-Do List",
        whiteboardTab: "Whiteboard",
        whiteboardTitle: "Case Whiteboard & Investigation Board",
        whiteboardDesc: "Organize clues, suspects, locations, and evidence visually.",
        newCardBtn: "New Card",
        connectModeBtn: "Connect Cards",
        connectingModeActive: "Click target card to connect",
        importEvidenceBtn: "Import Evidence",
        categorySuspect: "Suspect",
        categoryEvidence: "Evidence",
        categoryLocation: "Location",
        categoryVehicle: "Vehicle",
        categoryWitness: "Witness",
        categoryVictim: "Victim",
        categoryNote: "Note",
        categoryTodo: "Task / To-Do",
        categoryTimeline: "Timeline",
        cardTitleLabel: "Card Title",
        cardCategoryLabel: "Category",
        cardColorLabel: "Color Theme",
        cardDescriptionLabel: "Description",
        cardImageLabel: "Image (Upload file or URL)",
        inactiveCardLabel: "Mark as Inactive / Out of Operation (Red cross)",
        inactiveBadge: "INACTIVE",
        linkLabelPlaceholder: "Relationship (e.g. Suspect of, Seen at)",
        savingBoardStatus: "Saving...",
        savedBoardStatus: "Saved",
        emptyBoardMessage: "The whiteboard is empty. Add a new card or import case evidence to get started!",
        importTodoBtn: "Import To-Do",
        timelineToolBtn: "Timeline",
        addToBoardBtn: "Pin to Board",
        taskAddedToBoard: "Task added to whiteboard!",
        categoryAddedToBoard: "Category added to whiteboard!",
        timelineModalTitle: "Case Chronological Timeline",
        addTimelineEventBtn: "Add Custom Milestone",
        generateTimelineOnBoard: "Generate Timeline on Board",
        eventDateLabel: "Date",
        eventTimeLabel: "Time",
        eventTitleLabel: "Event Title",
        eventDescLabel: "Event Narrative",
        insertEventToBoard: "Pin to Board",
        timelineGeneratedSuccess: "Timeline events added and connected on the whiteboard!",
        importTodoModalTitle: "Import To-Do Tasks to Board",
        importSelectedTasksBtn: "Import Selected Tasks",
        noTasksFound: "No tasks found in To-Do list.",
        taskCompletedStatus: "Completed",
        taskPendingStatus: "Pending",
        pencilToolBtn: "Pencil & Shapes",
        ...
        rectShape: "Rectangle",
        circleShape: "Circle",
        clearDrawingsBtn: "Clear Drawings",
        strokeThickness: "Thickness",
        lockPosition: "Lock Position",
        unlockPosition: "Unlock Position",
        linkEntriesTitle: "Link to Log Updates / Entries",
        linkedEntries: "Linked Log Entries",
        viewInLogBtn: "View in Log",
        linkedEntryPreview: "Linked Entry Details",
        ...
        editGangNameTitle: "Edit Syndicate Details",
        ...
        detectivesInCharge: "Detectives in Charge",
        detectiveInCharge1: "Detective in Charge 1",
        detectiveInCharge2: "Detective in Charge 2",
        ...
        linkedGangs: "Linked Criminal Groups",
        noLinkedGangs: "No linked criminal groups",
        ...
        tabletExistsWarning: "The tablet report number '{number}' already exists in the database. Are you sure you want to add it?",
        ...
        incidentDescription: "Incident / Collection Description",
        ...
        linkedBallistics: "Linked Ballistics",
        linkedCoincidences: "Ballistic Matches",
        linkToCase: "Link to Case",
        unlinkFromCase: "Unlink Case",
        changeCase: "Change Case",
        rejectCoincidence: "Reject Match",
        reopenCoincidence: "Reopen Match",
        statusOpen: "Open",
        statusLinkedCase: "With Case",
        statusRejected: "Rejected",
        filterAll: "All",
        filterOpen: "Open",
        filterWithCase: "With Case",
        filterRejected: "Rejected",
        rejectionReason: "Rejection Reason",
        rejectionReasonPlaceholder: "e.g. False positive, discarded lead, weapon sold before incident...",
    ...
    es: {
        ...
        asd: "ASD",
        undercover: "Undercover",
        undercoverDivision: "División Undercover",
        ud: "UD",
        coordination: "Coordinación",
        coordinationTasks: "Tareas Pendientes Coordinación",
        sanctionsRegister: "Registro de Sanciones",
        ...
        initialReport: "Claves del caso / Descripción",
        initialReportPlaceholder: "Describe las claves del caso...",
        ...
        deleteBtn: "Eliminar",
        initialReportTitle: "CLAVES DEL CASO",
        clickToExpand: "Clic para expandir",
        updatesAndEvidenceTab: "Actualizaciones y Evidencia",
        toDoListTab: "Lista de Tareas",
        whiteboardTab: "Pizarra",
        whiteboardTitle: "Pizarra de Investigación del Caso",
        whiteboardDesc: "Organiza pistas, sospechosos, lugares y evidencias de forma visual.",
        newCardBtn: "Nueva Tarjeta",
        connectModeBtn: "Conectar Tarjetas",
        connectingModeActive: "Haz clic en la tarjeta de destino para unir",
        importEvidenceBtn: "Importar Evidencias",
        categorySuspect: "Sospechoso",
        categoryEvidence: "Evidencia",
        categoryLocation: "Ubicación",
        categoryVehicle: "Vehículo",
        categoryWitness: "Testigo",
        categoryVictim: "Víctima",
        categoryNote: "Nota",
        categoryTodo: "Tarea / To-Do",
        categoryTimeline: "Línea de Tiempo",
        cardTitleLabel: "Título de Tarjeta",
        cardCategoryLabel: "Categoría",
        cardColorLabel: "Color / Tema",
        cardDescriptionLabel: "Descripción",
        cardImageLabel: "Imagen (Subir archivo o URL)",
        inactiveCardLabel: "Marcar como Inactivo / No activo (Mostrar cruz roja)",
        inactiveBadge: "INACTIVO",
        linkLabelPlaceholder: "Relación (ej. Sospechoso de, Visto en)",
        savingBoardStatus: "Guardando...",
        savedBoardStatus: "Guardado",
        emptyBoardMessage: "La pizarra está vacía. ¡Añade una tarjeta o importa las evidencias del caso para empezar!",
        importTodoBtn: "Importar To-Do",
        timelineToolBtn: "Línea de Tiempo",
        addToBoardBtn: "Enviar a Pizarra",
        taskAddedToBoard: "¡Tarea añadida a la pizarra!",
        categoryAddedToBoard: "¡Lista de tareas añadida a la pizarra!",
        timelineModalTitle: "Línea de Tiempo Cronológica del Caso",
        addTimelineEventBtn: "Añadir Hito Cronológico",
        generateTimelineOnBoard: "Generar Línea de Tiempo en Pizarra",
        eventDateLabel: "Fecha",
        eventTimeLabel: "Hora",
        eventTitleLabel: "Título del Suceso / Hito",
        eventDescLabel: "Descripción de los Hechos",
        insertEventToBoard: "Añadir a Pizarra",
        timelineGeneratedSuccess: "¡Hitos de la línea de tiempo añadidos y conectados en la pizarra!",
        importTodoModalTitle: "Importar Tareas To-Do a la Pizarra",
        importSelectedTasksBtn: "Importar Tareas Seleccionadas",
        noTasksFound: "No hay tareas en la lista To-Do.",
        taskCompletedStatus: "Completado",
        taskPendingStatus: "Pendiente",
        pencilToolBtn: "Lápiz y Formas",
        eraserToolBtn: "Goma de Borrar",
        undoBtn: "Deshacer (Ctrl+Z)",
        redoBtn: "Rehacer (Ctrl+Y)",
        addImageBtn: "Añadir Imagen",
        moveModeBtn: "Mover",
        tacticalShape: "Forma",
        freehandShape: "Mano Alzada",
        lineShape: "Línea",
        arrowShape: "Flecha",
        rectShape: "Rectángulo",
        circleShape: "Círculo",
        clearDrawingsBtn: "Borrar Trazos",
        strokeThickness: "Grosor",
        lockPosition: "Fijar Posición",
        unlockPosition: "Desfijar Posición",
        linkEntriesTitle: "Vincular a Novedades / Entradas del Caso",
        linkedEntries: "Entradas vinculadas",
        viewInLogBtn: "Ver en la Bitácora",
        linkedEntryPreview: "Detalle de Entrada Vinculada",
        ...
        editGangNameTitle: "Editar Grupo",
        ...
        detectivesInCharge: "Detectives al Cargo",
        detectiveInCharge1: "Detective al Cargo 1",
        detectiveInCharge2: "Detective al Cargo 2",
        ...
        linkedGangs: "Grupos Criminales Vinculados",
        noLinkedGangs: "Sin grupos criminales vinculados",
        ...
        tabletExistsWarning: "El número de informe tablet '{number}' ya se encuentra en la BBDD, ¿estás seguro de que quieres añadirlo?",
        ...
        incidentDescription: "Descripción del Incidente / Recogida",
        ...
        linkedBallistics: "Balística Vinculada",
        linkedCoincidences: "Coincidencias Balísticas",
        linkToCase: "Vincular a Caso",
        unlinkFromCase: "Desvincular Caso",
        changeCase: "Cambiar Caso",
        rejectCoincidence: "Rechazar Coincidencia",
        reopenCoincidence: "Reabrir Coincidencia",
        statusOpen: "Abierta",
        statusLinkedCase: "Con Caso",
        statusRejected: "Rechazada",
        filterAll: "Todas",
        filterOpen: "Abiertas",
        filterWithCase: "Con Caso",
        filterRejected: "Rechazadas",
        rejectionReason: "Motivo del Rechazo",
        rejectionReasonPlaceholder: "ej. Falso positivo, estrías inconsistentes, arma vendida antes del hecho...",
